...
export default function Attendance({handleSidebar, showSidebar}){
                    ...
                    <div className="row mt-4">
                        <div className="col-lg-12 col-sm-12 col-md-12 col-12">
                            <div className="basic-tabs">
                                <div className="tabs">
                                    <div className={`tab-indicator ${openTab === "attendanceListTab" ? "active" : ""}`}  
                                        id='attendanceListTab' 
                                        onClick={(e) => handleClick(e)}
                                    >
                                        <span className="tab-title">Kehadiran</span>
                                    </div>
                                </div>
                                <div className="tabs-content" style={openTab === "attendanceListTab" ? {display: "block"} : {display: "none"}}>
