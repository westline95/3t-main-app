...
export default function Department({ handleSidebar, showSidebar }) {
    ...
    const statusCell = (rowData) => {
        return (
            <span className={`badge badge-${rowData.status == "in-stock" ? 'primary'
            ...
            <div className="col-12" key={rowData.category_id} style={{ position: 'relative' }}>
                ...
                >
                    ...
                    >
                        ...
                        <div style={{ width: '80%' }}>
                            <p style={{ marginBottom: 0, fontSize: 15, fontWeight: 600 }}>{rowData.department_name}</p>
                            <p style={{ marginBottom: 0, fontSize: 13, color: '#7d8086' }}>{rowData.department_id}</p>
                        </div>
                    </div>
                </div>
